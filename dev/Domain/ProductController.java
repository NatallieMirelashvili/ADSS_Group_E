...
public class ProductController {
    ...
    public ArrayList<Product> RequestDeliveryCTR(String myManufacturer) {
    ...
    public boolean checkMinimalAmountCTR(int catNum) {
        ...
        boolean res =productToUpdate.checkMinimalProd();
        if(res){
            myProductRepo.setIsMinimal(productToUpdate, true);
        }
        return res;
    }
